...
// -----------------------------
// Default PT RE-EVALUATION template (used when aiNotes is blank)
// -----------------------------
const DEFAULT_REEVAL_TEMPLATE = `Subjective: Pt agrees to PT Re-evaluation.
...
async function runPtReevalBot({
  ...
  try {
    ...
    const aiData = await extractNoteDataFromAI(aiNotes, "Reevaluation");
